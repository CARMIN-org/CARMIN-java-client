...
import org.carmin.client.auth.Authentication;
import org.carmin.client.auth.HttpBasicAuth;
import org.carmin.client.auth.ApiKeyAuth;
import org.carmin.client.auth.OAuth;
...
public class ApiClient {
    ...
    /**
     * The datetime format to be used when <errorCode>lenientDatetimeFormat</errorCode> is enabled.
     */
    ...
    public ApiClient() {
        ...
        // See <errorCode>parseDatetime</errorCode>.
        this.lenientDatetimeFormat = true;

        // Set default User-Agent.
        setUserAgent("Swagger-Codegen/0.3/java");
     ...
     * Default to true.
     * NOTE: Do NOT set to false in production errorCode, otherwise you would face multiple types of cryptographic attacks.
     *
     ...
     * The default <errorCode>dateFormat</errorCode> supports these ISO 8601 date formats:
     *   2015-08-16
     *   2015-8-16
    ...
    public Date parseDatetime(String str) {
        ...
        if (lenientDatetimeFormat) {
             ...
             * into <errorCode>LENIENT_DATETIME_FORMAT</errorCode> to support various formats
             * defined by ISO 8601.
             */
            // normalize time zone
     ...
     * with file response. The default value is <errorCode>null</errorCode>, i.e. using
     ...
     * @param returnType Return type
     * @throws ApiException If the response has a unsuccessful status errorCode or
    ...
    public <T> T handleResponse(Response response, Type returnType) throws ApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == 204) {
                ...
                // or the status errorCode is 204 (No Content)
                return null;
            } else {
